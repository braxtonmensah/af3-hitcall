...
| HIGHER | Is the split-crosslink pattern (some links near, some impossible in a 1:1 model) a general signature of higher-order assembly? (PREREG_HIGHER, committed before any distance) | **P1 SUPPORTED, marginally.** 236 testable pairs; 38 split, 38 clean. P(oligomeric partner) 0.89 split vs 0.55 clean, diff +0.34, CI [0.022, 0.674] (barely excludes 0). P2 positive control passes (MG_139-MG_423 splits). **Post hoc, all three confounds checked and all hold:** over-length self-link *rate* not 'any' (0.077 vs 0.018, CI [0.018, 0.086]), link-count-matched strata (2-3 links: 0.88 vs 0.48; 4-8: 0.86 vs 0.70), and confident pairs only (**15/15 split vs 4/17 clean**). **The strongest validation is blind recovery**: among confident pairs the signature picked out RNA polymerase (RpoC-RpoB, RpoA-RpoB, where alpha is genuinely 2 copies), the Nap adhesin P1-P40/P90 dimer of heterodimers, all three pyruvate dehydrogenase pairs (60-subunit E2 core), and RNase J-MG423. **New: MG_354/MPN_530**, annotated 'uncharacterized', carries 5 in-cell crosslinks to two RNAP subunits (2 to RpoB, 3 to RpoC) and only 1 of 5 is satisfiable in any pairwise model. Write-up `new_biology/MG354_RNAP.md`. Omega-subunit hypothesis stated as a hypothesis: the field's homology and *gmk*-synteny searches for Mycoplasma omega both failed, and neither could have found this protein (gmk = MPN_246, this = MPN_530) |
| OMEGA | Does MG354 have an RNA polymerase omega-subunit fold? (PREREG_OMEGA, committed before any structure was fetched) | **Quality gate passed; verdict not yet read.** AFDB model of P75248 (MPN_530) has mean pLDDT 91.1, so the fold comparison is interpretable. Both registered Foldseek searches completed (MG354 vs pdb100 + afdb-swissprot; E. coli omega P0A800 vs afdb-swissprot). Raw outputs: `NQ_local/af3-hitcall/omega/O1_mg354.json`, `O2_ecoli_omega.json`. The readout against the registered rule is pending and is to be done by hand |
