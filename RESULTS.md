...
| RNAP3 | Does a three-chain model place MG354's five in-cell crosslinks within reach? (PREREG_RNAP3, committed d605b06 before any prediction) | **SUPPORTED.** AlphaFold Server, MPN_530 + RpoB + RpoC, 2,817 residues, 5 samples, run 2026-09-25. **Control read first, as registered: RpoB-RpoC 0.95 of 20 links within 30 A in all five samples** (bar was 0.70; median 18-19 A), and chain-pair ipTM 0.910 in every sample, so the model reproduces the known interface and MG354 is interpretable. **T1 primary, best sample: 4 of 5 MG354 links satisfied** (22-RpoC1060 13.0 A; 55-RpoB262 20.8 A; 128-RpoC171 15.6 A; 128-RpoC375 19.8 A), against a random-lysine null of mean 0.08 and p95 0.40. Registered rule needs >= 4 of 5 and beating the null: both met. **Sample structure matters and is reported:** 3 of 5 samples give 4/5, two give 1-2/5, and the two readouts agree independently. MG354 chain-pair ipTM is 0.57 (RpoB) / 0.43 (RpoC) in the three satisfying samples and collapses to 0.17 / 0.15 in the two that do not. Confidence and crosslink satisfaction move together. **One link fails in all five samples**: MG354 residue 1 to RpoB 289, 50-52 A. Residue 1 is the N-terminal residue, the least reliable crosslink assignment and a flexible terminus. **Reading:** MG354 contacts the assembled RNA polymerase core, touching both beta and beta-prime, which is what the pairwise models could not show. This is computational plus published crosslinks; no experiment was performed. AF Server output is non-commercial. `cleanroom/rnap3/score_rnap3.py`, models in NQ_local/af3-hitcall/rnap3 |
