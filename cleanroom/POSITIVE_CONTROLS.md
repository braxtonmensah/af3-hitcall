...
| 7 | **AN7973** (6-carboxamide benzoxaborole) | not retrieved | not retrieved (MCE catalogue item) | *T. brucei* / *C. parvum* CPSF3 (**inferred, and see dispute note**) | Trypanocidal and anti-*Cryptosporidium* activity; disrupts mRNA processing | **NO** | none | PLOS Pathog 2018;14:e1007315 (PMC6173450; PMID not verified in this survey); mechanism complication: Giordani et al., PLOS Pathog 2020;16:e1008932, doi:10.1371/journal.ppat.1008932, PMID 33141865 |
...
| 14 | **Inositol hexakisphosphate (IP6 / phytic acid)** (PDB ligand **IHP**) | CHEMBL1233511 (phytic acid) | `C1(C(C(C(C(C1OP(=O)(O)O)OP(=O)(O)O)OP(=O)(O)O)OP(=O)(O)O)OP(=O)(O)O)OP(=O)(O)O` (PDB) | **INTS4-INTS9-INTS11 Integrator cleavage module** (INTS11 is the CPSF73 paralogue, MBL-beta-CASP) | Not a potency measurement. Structurally ordered, functionally required: mutation of the pocket or disruption of IP6 biosynthesis reduces snRNA 3'-end processing and transcription attenuation | **YES, and at a protein-protein INTERFACE**, 55 A from the INTS11 active site, contacting all three subunits (INTS4 K189; INTS9 R2/R504/K508/R509; INTS11 K462) | **7SN8** (2.74 A cryo-EM, *Drosophila*); same site confirmed in human ICM | Lin, Jia et al., Nat Commun 2022;13:5742, doi:10.1038/s41467-022-33506-3, PMID 36180473 |
...
| 16 | **UMP** (uridine 5'-monophosphate) | CHEMBL214393 | `O[C@@H]1[C@H](O)[C@@H](COP(O)(O)=O)O[C@H]1N1C=CC(=O)NC1=O` | **RNase J** (*Thermus thermophilus*), soaked into the 5'-monophosphate sensing pocket | Substrate-fragment complex. No potency. Not an inhibitor | Structural only | **3BK2**, **4XWT** | Li de la Sierra-Gallay et al. (3BK1/3BK2); Dorleans et al./Zhao et al. (4XWT/4XWW) |
...
3. What actually comes back instead, and why it is not what you need:
   - **RnpA (RNase P protein) inhibitors in *S. aureus***: RNPA2000 and derivatives,
     ...
     disputed.** Schencking et al., *RNase P Inhibitors Identified as Aggregators*, AAC 2021,
...
- **AN7973 / AN11736: mechanism complicated.** Giordani et al. showed these veterinary
  ...
  PMID 33141865. CPSF3 remains the proposed target but the potency numbers do not report
  target engagement.
...
- Giordani F, et al. Veterinary trypanocidal benzoxaboroles are peptidase-activated prodrugs. PLoS Pathog. 2020;16:e1008932. doi:10.1371/journal.ppat.1008932. [PMID 33141865](https://journals.plos.org/plospathogens/article?id=10.1371%2Fjournal.ppat.1008932)
...
- Schencking I, et al. RNase P Inhibitors Identified as Aggregators. Antimicrob Agents Chemother. 2021. doi:10.1128/aac.00300-21. [PMID 33972249](https://pubmed.ncbi.nlm.nih.gov/33972249/)
